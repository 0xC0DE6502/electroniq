...
// include: F:\VSCode\data\tmp\tmpisr8o6tt.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'electroniq.data';
      var REMOTE_PACKAGE_BASE = 'electroniq.data';
...
Module['FS_createPath']("/", "quickplay", true, true);
Module['FS_createPath']("/", "roms", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_electroniq.data');

      };
      Module['addRunDependency']('datafile_electroniq.data');
    ...
    loadPackage({"files": [{"filename": "/dejavu.ttf", "start": 0, "end": 331992}, {"filename": "/quickplay/electrobots.ssd", "start": 331992, "end": 357336}, {"filename": "/quickplay/flappy-bird.ssd", "start": 357336, "end": 562136}, {"filename": "/quickplay/meteors++.ssd", "start": 562136, "end": 766936}, {"filename": "/quickplay/soko-ban.ssd", "start": 766936, "end": 971736}, {"filename": "/roms/ap6.rom", "start": 971736, "end": 979508}, {"filename": "/roms/basic2.rom", "start": 979508, "end": 995892}, {"filename": "/roms/dfs.rom", "start": 995892, "end": 1012276}, {"filename": "/roms/mmfs.rom", "start": 1012276, "end": 1028660}, {"filename": "/roms/os100.rom", "start": 1028660, "end": 1045044}, {"filename": "/roms/plus1.rom", "start": 1045044, "end": 1049140}], "remote_package_size": 1049140});

  })();

// end include: F:\VSCode\data\tmp\tmpisr8o6tt.js
...
var ASM_CONSTS = {
  623672: () => { if (document.fullscreenElement) return 1; },  
 623718: () => { return document.getElementById('canvas').width; },  
 623770: () => { return parseInt(document.getElementById('canvas').style.width); },  
 623838: () => { document.exitFullscreen(); },  
 623865: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 623938: () => { if (document.fullscreenElement) return 1; },  
 623984: () => { return document.getElementById('canvas').width; },  
 624036: () => { return screen.width; },  
 624061: () => { document.exitFullscreen(); },  
 624088: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 624221: () => { return window.innerWidth; },  
 624247: () => { return window.innerHeight; },  
 624274: () => { if (document.fullscreenElement) return 1; },  
 624320: () => { return document.getElementById('canvas').width; },  
 624372: () => { return parseInt(document.getElementById('canvas').style.width); },  
 624440: () => { if (document.fullscreenElement) return 1; },  
 624486: () => { return document.getElementById('canvas').width; },  
 624538: () => { return screen.width; },  
 624563: () => { return window.innerWidth; },  
 624589: () => { return window.innerHeight; },  
 624616: () => { if (document.fullscreenElement) return 1; },  
 624662: () => { return document.getElementById('canvas').width; },  
 624714: () => { return screen.width; },  
 624739: () => { document.exitFullscreen(); },  
 624766: () => { if (document.fullscreenElement) return 1; },  
 624812: () => { return document.getElementById('canvas').width; },  
 624864: () => { return parseInt(document.getElementById('canvas').style.width); },  
 624932: () => { document.exitFullscreen(); },  
 624959: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 625017: () => { return screen.width; },  
 625042: () => { return screen.height; },  
 625068: () => { return window.screenX; },  
 625095: () => { return window.screenY; },  
 625122: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 625175: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 625246: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 625303: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 625559: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 625630: () => { if (document.fullscreenElement) return 1; },  
 625676: () => { return window.innerWidth; },  
 625702: () => { return window.innerHeight; },  
 625729: () => { if (document.pointerLockElement) return 1; },  
 625776: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === window.miniaudio.device_state.started) { device.webaudio.resume().then(() => { Module._ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 627934: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 628098: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 628202: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 628373: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(Module.HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == miniaudio.device_type.playback || deviceType == miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return miniaudio.track_device(device); },  
 631201: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 631267: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 631660: ($0) => { miniaudio.untrack_device_by_index($0); },  
 631703: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 631828: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
function save_to_localstorage(key,value) { localStorage.setItem(UTF8ToString(key), UTF8ToString(value)); }
function load_from_localstorage(key,value,length) { const storedValue=localStorage.getItem(UTF8ToString(key)); if (storedValue) stringToUTF8(storedValue, value, length); else stringToUTF8("", value, length); }
...
var _Tape_Insert = Module['_Tape_Insert'] = (a0) => (_Tape_Insert = Module['_Tape_Insert'] = wasmExports['Tape_Insert'])(a0);
var _DiskDrive_Insert = Module['_DiskDrive_Insert'] = (a0, a1) => (_DiskDrive_Insert = Module['_DiskDrive_Insert'] = wasmExports['DiskDrive_Insert'])(a0, a1);
var _SDCard_Insert = Module['_SDCard_Insert'] = (a0) => (_SDCard_Insert = Module['_SDCard_Insert'] = wasmExports['SDCard_Insert'])(a0);
var _Keyboard_SetAutoBoot = Module['_Keyboard_SetAutoBoot'] = (a0, a1) => (_Keyboard_SetAutoBoot = Module['_Keyboard_SetAutoBoot'] = wasmExports['Keyboard_SetAutoBoot'])(a0, a1);
var _Memory_LoadROM = Module['_Memory_LoadROM'] = (a0, a1, a2) => (_Memory_LoadROM = Module['_Memory_LoadROM'] = wasmExports['Memory_LoadROM'])(a0, a1, a2);
var _Config_SetURLParamFinished = Module['_Config_SetURLParamFinished'] = (a0) => (_Config_SetURLParamFinished = Module['_Config_SetURLParamFinished'] = wasmExports['Config_SetURLParamFinished'])(a0);
var _Config_ParseURL = Module['_Config_ParseURL'] = (a0) => (_Config_ParseURL = Module['_Config_ParseURL'] = wasmExports['Config_ParseURL'])(a0);
var _Config_SaveSettings = Module['_Config_SaveSettings'] = () => (_Config_SaveSettings = Module['_Config_SaveSettings'] = wasmExports['Config_SaveSettings'])();
var _malloc = (a0) => (_malloc = wasmExports['malloc'])(a0);
var _Keyboard_PressBreak = Module['_Keyboard_PressBreak'] = (a0) => (_Keyboard_PressBreak = Module['_Keyboard_PressBreak'] = wasmExports['Keyboard_PressBreak'])(a0);
var _Keyboard_SetSpecialKeyState = Module['_Keyboard_SetSpecialKeyState'] = (a0, a1) => (_Keyboard_SetSpecialKeyState = Module['_Keyboard_SetSpecialKeyState'] = wasmExports['Keyboard_SetSpecialKeyState'])(a0, a1);
