...
// include: F:\VSCode\data\tmp\tmpaavk99i1.js
...
// end include: F:\VSCode\data\tmp\tmpaavk99i1.js
...
var ASM_CONSTS = {
  623544: () => { if (document.fullscreenElement) return 1; },  
 623590: () => { return document.getElementById('canvas').width; },  
 623642: () => { return parseInt(document.getElementById('canvas').style.width); },  
 623710: () => { document.exitFullscreen(); },  
 623737: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 623810: () => { if (document.fullscreenElement) return 1; },  
 623856: () => { return document.getElementById('canvas').width; },  
 623908: () => { return screen.width; },  
 623933: () => { document.exitFullscreen(); },  
 623960: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 624093: () => { return window.innerWidth; },  
 624119: () => { return window.innerHeight; },  
 624146: () => { if (document.fullscreenElement) return 1; },  
 624192: () => { return document.getElementById('canvas').width; },  
 624244: () => { return parseInt(document.getElementById('canvas').style.width); },  
 624312: () => { if (document.fullscreenElement) return 1; },  
 624358: () => { return document.getElementById('canvas').width; },  
 624410: () => { return screen.width; },  
 624435: () => { return window.innerWidth; },  
 624461: () => { return window.innerHeight; },  
 624488: () => { if (document.fullscreenElement) return 1; },  
 624534: () => { return document.getElementById('canvas').width; },  
 624586: () => { return screen.width; },  
 624611: () => { document.exitFullscreen(); },  
 624638: () => { if (document.fullscreenElement) return 1; },  
 624684: () => { return document.getElementById('canvas').width; },  
 624736: () => { return parseInt(document.getElementById('canvas').style.width); },  
 624804: () => { document.exitFullscreen(); },  
 624831: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 624889: () => { return screen.width; },  
 624914: () => { return screen.height; },  
 624940: () => { return window.screenX; },  
 624967: () => { return window.screenY; },  
 624994: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 625047: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 625118: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 625175: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 625431: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 625502: () => { if (document.fullscreenElement) return 1; },  
 625548: () => { return window.innerWidth; },  
 625574: () => { return window.innerHeight; },  
 625601: () => { if (document.pointerLockElement) return 1; },  
