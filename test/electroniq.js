...
// include: F:\VSCode\data\tmp\tmp9rzsnl6o.js
...
// end include: F:\VSCode\data\tmp\tmp9rzsnl6o.js
...
var ASM_CONSTS = {
  413856: () => { if (document.fullscreenElement) return 1; },  
 413902: () => { return document.getElementById('canvas').width; },  
 413954: () => { return parseInt(document.getElementById('canvas').style.width); },  
 414022: () => { document.exitFullscreen(); },  
 414049: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 414122: () => { if (document.fullscreenElement) return 1; },  
 414168: () => { return document.getElementById('canvas').width; },  
 414220: () => { return screen.width; },  
 414245: () => { document.exitFullscreen(); },  
 414272: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 414405: () => { return window.innerWidth; },  
 414431: () => { return window.innerHeight; },  
 414458: () => { if (document.fullscreenElement) return 1; },  
 414504: () => { return document.getElementById('canvas').width; },  
 414556: () => { return parseInt(document.getElementById('canvas').style.width); },  
